...
timeslots = TimeSlot.create(
  [
    {from_time: DateTime.now.next_day(1).to_time , to_time: DateTime.now.next_day(10).to_time, store_id: stores[0].id},
    {from_time: DateTime.now.next_day(1).to_time , to_time: DateTime.now.next_day(5).to_time, store_id: stores[0].id}
  ]
)
